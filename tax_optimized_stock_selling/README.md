# Tax-optimized Stock Selling Program
...
1. To update the Conda environment:
    1. `conda activate tax_optimized_stock_selling_env`
    1. `conda env update --file=environment.yml --prune` to take in the changes and uninstall removed dependencies.
